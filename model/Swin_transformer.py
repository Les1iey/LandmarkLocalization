...
#downsample
class PatchMerging_original(nn.Module):
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        self.patch_embed = PatchEmbed(in_channels=in_chans, patch_shape=patch_size,
                                      emb_size=embed_dim, img_shape=img_size,
    ...
    def forward(self, x):
        ...
        for layer in self.layers:
            ...
            st_x = trans_x.permute(0, 2, 1)        #B C HW
            st_x = st_x.contiguous().view(B, C, h, w)
            st_features.append(st_x)
